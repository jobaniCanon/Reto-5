    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnInsertar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    llenarCampos();
                    dbProductos.insertData(campo1Insert, campo2Insert, campo3Insert, imageInsert, name);
                    limpiarCampos();
        ...
        btnConsultar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Cursor cursor = dbProductos.getDataById(name, editId.getText().toString().trim());
        ...
        btnEliminar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dbProductos.deleteDataById(name,editId.getText().toString().trim());
                limpiarCampos();
        ...
        btnActualizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                llenarCampos();
                try{
                    dbProductos.updateProductoById(
                            name,
